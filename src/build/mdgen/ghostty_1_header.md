% GHOSTTY(1) Version @@VERSION@@ | GenQuery terminal emulator

# NAME

**ghostty** - GenQuery terminal emulator

# DESCRIPTION

GenQuery is a cross-platform, GPU-accelerated terminal emulator that aims to push
...
The unique goal of GenQuery is to have a platform for experimenting with modern,
...
While aiming for this ambitious goal, GenQuery is a fully standards compliant
