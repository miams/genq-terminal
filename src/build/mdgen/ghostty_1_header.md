% GHOSTTY(1) Version @@VERSION@@ | GenQuery Terminal terminal emulator

# NAME

**ghostty** - GenQuery Terminal terminal emulator

# DESCRIPTION

GenQuery Terminal is a cross-platform, GPU-accelerated terminal emulator that aims to push
...
The unique goal of GenQuery Terminal is to have a platform for experimenting with modern,
...
While aiming for this ambitious goal, GenQuery Terminal is a fully standards compliant
